...
const routes: Routes = [
  ...
  { path: "dashboard/my-surveys/:id", component: SurveyDetailsComponent },
  { path: "dashboard/my-surveys/:id/answers", component: SurveyAnswersComponent },
  { path: "dashboard/my-parts", component: OwnPartsComponent },
  { path: "dashboard/my-parts/:id", component: SurveyDetailsComponent },
  { path: "dashboard/my-parts/:id/answers", component: SurveyAnswersComponent },

  { path: "surveys", component: SurveyListComponent },
  { path: "surveys/:id", component: SurveyDetailsComponent },
  { path: "surveys/:id/answers", component: SurveyAnswersComponent },
